    ...
    <div className="px-6 md:px-9 pt-12 md:pt-16 pb-0">
      ...
      <div className="mt-8 md:mt-10 w-full pb-4">
        ...
        <div className="md:hidden">
          {coins.length > 0 ? (
            <>
              <div className="grid grid-cols-[minmax(0,1.15fr)_92px_minmax(86px,0.85fr)] items-center border-b border-[#e5e7eb] pb-3 text-[12px] font-medium text-[#6b7280]">
                <div>Asset</div>
              ...
              {coins.map((coin, index) => (
                <div
                  key={coin.name}
                  className="grid grid-cols-[minmax(0,1.15fr)_92px_minmax(86px,0.85fr)] items-center gap-2 border-b border-[#e5e7eb] py-4 last:border-b-0"
                >
                  <div className="flex min-w-0 items-center gap-3">
                    <div className="flex h-[34px] w-[34px] shrink-0 items-center justify-center rounded-full bg-[#f1f3f5]">
                      {coin.logo && (
                        <img
                          src={coin.logo}
                          alt={coin.name}
                  ...
                  <div className="flex justify-center">
                    <img
                      ...
                      alt="Price chart"
                      loading="lazy"
                      className="h-9 w-[86px] object-contain"
                    />
                  </div>
