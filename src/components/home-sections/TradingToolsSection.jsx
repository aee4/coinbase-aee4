...
const TradingToolsSection = () => {
  return (
    <section className="w-full bg-white px-5 md:px-10 py-16 md:py-24">
      <div className="mx-auto grid max-w-[1400px] items-center gap-12 md:gap-16 grid-cols-1 lg:grid-cols-2">
        {/* LEFT IMAGE */}
        <div className="flex justify-center lg:justify-end order-last lg:order-none">
          <div className="w-full max-w-[580px] rounded-[30px] md:rounded-[40px] bg-black p-3 md:p-5">
            <img
        ...
        <div className="flex justify-center lg:justify-start">
          <div className="max-w-[520px]">
            <h2 className="text-[32px] md:text-[42px] font-normal leading-[1.02] tracking-[-0.04em] text-black">
