...
const ExploreHero = () => {
  return (
    <div className="grid grid-cols-1 items-start gap-6 md:gap-10 px-5 md:px-9 py-8 md:py-10 lg:grid-cols-[1fr_560px]">
      <div>
        <h1 className="text-[32px] md:text-[42px] font-normal leading-tight md:leading-none tracking-[-0.04em] text-black">
          Explore crypto
        </h1>
      ...
      <div className="flex justify-start lg:justify-end mt-4 lg:mt-0">
        <div className="flex h-[54px] md:h-[60px] w-full max-w-[440px] items-center rounded-full bg-[#f1f3f5] px-5 md:px-7">
